...
static const char *fonts[]          = { "VictorMono Nerd Font:size=11:style=semibold,medium" };
static const char dmenufont[]       = "VictorMono Nerd Font:size=11:style=semibold";
static const char col_gray1[]       = "#222222";
static const char col_gray2[]       = "#444444";
static const char col_gray3[]       = "#bbbbbb";
static const char col_gray4[]       = "#1e0f10";  // "#eeeeee";
static const char col_cyan[]        = "#4fc1ff"; // "#c77a00";  //"#005577";
...
static const char *rofiemocmd[] = { "rofi", "-show", "emoji", NULL };
static const char *roficalcmd[] = { "rofi", "-show", "calc", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
    { MODKEY,                       XK_s,      spawn,          {.v = screenshoot }},
	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
	{ MODKEY,                       XK_a,      spawn,          {.v = rofiappcmd } },
	{ MODKEY,                       XK_w,      spawn,          {.v = rofiwincmd } },
	{ MODKEY,                       XK_e,      spawn,          {.v = rofiemocmd } },
	{ MODKEY,                       XK_c,      spawn,          {.v = roficalcmd } },
